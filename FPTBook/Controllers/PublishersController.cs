...
namespace FPTBook.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfileURL,Id,Name,Bio")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfileURL,Id,Name,Bio")] Publisher publisher)
        {
            if (id != publisher.Id)
            {
                return NotFound();
